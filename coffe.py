...
def belanja():
    print("Selamat datang di caffe juara, selamat berbelanja")
    ...
    print("total yang harus dibayar adalah",total_belanja+pajak,"terima kasih telah berbelanja di caffeshop juaraca")
